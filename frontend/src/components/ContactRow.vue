  ...
  >
    ...
    <div class="actions" v-if="!disabled">
      <button class="icon-btn" title="Editar" @click.stop="$emit('edit', contact)">
        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M4 21h17" stroke="#444" stroke-width="2"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19.5 3 21l1.5-4L16.5 3.5Z" stroke="#444" stroke-width="2"/></svg>
      </button>
      <button class="icon-btn" title="Excluir" @click.stop="$emit('delete', contact)">
        <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M3 6h18" stroke="#444" stroke-width="2"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m2 0v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V6h12Z" stroke="#444" stroke-width="2"/></svg>
      </button>
    </div>
  </div>
</template>
